    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col d-flex justify-content-center">
                <H1 id="h1mainTitleIndex">BIRDLAND</H1>
            </div>
        </div>
        <div class="row">
            <div class="col d-flex justify-content-center">
        ...
        <div class="row">
            <div class="col-xl-6 col-sm-12 d-flex justify-content-center"><span class="blocCategory text-center"><a class="blocCategoryText" href="collection.php">COLLECTION</a></span></div>
